          ...
          <Col className="mb-3 mb-sm-0" sm={4}>
            <Card>
              <Nav.Link href="/admin/user_tools">
                {" "}
                <Card.Img className="img-fluid"  variant="top" src={user_image} />
              </Nav.Link>
              <Card.Body>
                <Card.Title>User Tools</Card.Title>
                <Card.Text>
                  User Teams and Roles management Update, Delete and Create Tool
                </Card.Text>
              </Card.Body>
            </Card>
          </Col>
          <Col className="mb-3 mb-sm-0" sm={4}>
            <Card>
              <Nav.Link href="/admin/operational_tools">
                {" "}
                <Card.Img  className="img-fluid"  variant="top" src={operations_image} />
              </Nav.Link>
              <Card.Body>
                <Card.Title>Operational Tools</Card.Title>
                <Card.Text>
                  System Operational Tools i.e Departments Environment and main
          ...
          <Col className="mb-3 mb-sm-0" sm={4}>
            <Card>
              <Nav.Link href="/admin/main_project_tools">
                <Card.Img  className="img-fluid" variant="top" src={main_operation_image} />
              </Nav.Link>
              <Card.Body>
                <Card.Title>Main Project Tools</Card.Title>
                <Card.Text>
                  Newly Added Feature for main projects management i.e status
                  and categories of the main system and bushiness projects
                </Card.Text>
              </Card.Body>
            </Card>
          </Col>

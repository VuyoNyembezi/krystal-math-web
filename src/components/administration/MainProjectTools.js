...
function MainProjectTools() {
  ...
  const handle_update_Close_status = () => {
    set_update_Show_status(false);
    setToolFormValue({
      id: 0,
      name: "",
    });
  ...
  const handle_update_Close_priority = () => {
    set_update_Show_priority(false);
    setToolFormValue({
      id: 0,
      name: "",
    });
  ...
  const handle_Close_Project_type = () => {
  ...
  const [show_update_project_type, set_update_Show_project_type] =
    useState(false);
  const handle_update_Show_project_type = () =>
    set_update_Show_project_type(true);
  const handle_update_Close_project_type = () => {
    set_update_Show_project_type(false);
    setToolFormValue({
      id: 0,
      name: "",
    });
  ...
  const [show_delete_project_type, set_delete_Show_project_type] =
    useState(false);
  const handle_delete_Show_project_type = () =>
    set_delete_Show_project_type(true);
  const handle_delete_Close_project_type = () =>
    set_delete_Show_project_type(false);
  ...
  const [
    show_update_project_category_type,
    set_update_Show_project_category_type,
  ] = useState(false);
  const handle_update_Show_project_category_type = () =>
    set_update_Show_project_category_type(true);
  const handle_update_Close_project_category_type = () => {
    set_update_Show_project_category_type(false);
    setToolFormValue({
      id: 0,
      name: "",
    });
  ...
  const [
    show_delete_project_category_type,
    set_delete_Show_project_category_type,
  ] = useState(false);
  const handle_delete_Show_project_category_type = () =>
    set_delete_Show_project_category_type(true);
  const handle_delete_Close_project_category_type = () =>
    set_delete_Show_project_category_type(false);
  ...
  const latest_project_type_data = useMemo(
    () => old_project_type_data,
    [old_project_type_data]
  );
  const latest_project_category_type_data = useMemo(
    () => old_project_category_data,
    [old_project_category_data]
  );
  const latest_project_status_data = useMemo(
    () => old_project_status_data,
    [old_project_status_data]
  );
  const latest_priority_type_data = useMemo(
    () => old_priority_type_data,
    [old_priority_type_data]
  );
  // project type
  useEffect(() => {
    ...
    fetch(`${URL}/api/auth/project_type/all`, requestOptions)
      ...
      .then((Result) => {
        setProjectTypeData(Result.data);
      });
  ...
  useEffect(() => {
    ...
    fetch(`${URL}/api/auth/project_category_type/all`, requestOptions)
      .then((response) => response.json())
      .then((Result) => {
        setProjectCategoryTypeData(Result.data);
      });
  ...
  return (
    <div className="mt-3">
      <Container fluid>
        <Card>
          <Card.Header>System Tools</Card.Header>
          <Card.Body className="admin-main-project-tool-card">
            <Tabs defaultActiveKey="project types" className="mb-3">
              <Tab eventKey="project types" title="Project Types">
                <Button
                  variant="outline-success"
                  size="sm"
                  onClick={handleShowProjectType}
                >
                          ...
                          <td className="text-center">
                            ...
                            >
                              <Button
                                variant="outline-success"
                                size="sm"
                                onClick={handle_update_Show_project_type}
                              >
                                Update
                              </Button>
                            </button>{" "}
                            ...
                            >
                              <Button
                                ...
                                size="sm"
                                onClick={handle_delete_Show_project_type}
                              >
                                Delete
                              </Button>
                            </button>{" "}
              ...
              <Tab eventKey="project category" title="Project Category">
                <Button
                  variant="outline-success"
                  size="sm"
                  onClick={handleShowProjectCategory}
                >
                          ...
                          <td className="text-center">
                            ...
                            >
                              <Button
                                ...
                                size="sm"
                                onClick={
                                  handle_update_Show_project_category_type
                                }
                              >
                                Update
                              </Button>
                            ...
                            >
                              <Button
                                ...
                                size="sm"
                                onClick={
                                  handle_delete_Show_project_category_type
                                }
                              >
                                Delete
                              </Button>
                          ...
                          <td className="text-center">
                            ...
                            >
                              <Button
                                variant="outline-success"
                                size="sm"
                                onClick={handle_update_Show_status}
                              >
                                Update
                              </Button>
                            </button>{" "}
                            ...
                            >
                              <Button
                                variant="outline-danger"
                                size="sm"
                                onClick={handle_delete_Show_status}
                              >
                                Delete
                              </Button>
                            </button>
                          ...
                          <td className="text-center">
                            ...
                            >
                              <Button
                                variant="outline-success"
                                size="sm"
                                onClick={handle_update_Show_priority}
                              >
                                Update
                              </Button>
                            </button>{" "}
                            ...
                            >
                              <Button
                                variant="outline-danger"
                                size="sm"
                                onClick={handle_delete_Show_priority}
                              >
                                Delete
                              </Button>
                            </button>
      ...
      <Modal
        show={show_Project_Category_Type}
        onHide={handle_Project_Category_Close}
      >
        <Modal.Header closeButton>
      ...
      <Modal
        show={show_update_project_type}
        onHide={handle_update_Close_project_type}
      >
        <Modal.Header closeButton>
        ...
        <Modal.Body>
          <Form onSubmit={handle_Update_Project_Type_Submit}>
            ...
            <Button
              variant="secondary"
              onClick={handle_update_Close_project_type}
            >
              Close
            </Button>{" "}
            <Button variant="success" type="submit">
      ...
      <Modal
        show={show_update_project_category_type}
        onHide={handle_update_Close_project_category_type}
      >
        <Modal.Header closeButton>
        ...
        <Modal.Body>
          <Form onSubmit={handle_Update_Project_Category_Type_Submit}>
            ...
            <Button
              variant="secondary"
              onClick={handle_update_Close_project_category_type}
            >
              Close
            </Button>{" "}
            <Button variant="success" type="submit">
      ...
      <Modal show={show_update_priority} onHide={handle_update_Close_priority}>
        ...
        <Modal.Body>
          <Form onSubmit={handle_Update_Priority_Submit}>
            ...
            <InputGroup className="mb-3">
              <InputGroup.Text className="col-4" id="level">
                Color :
              </InputGroup.Text>
              <FormControl
                aria-label="level"
      ...
      {/*  Project  Types */}
      <Modal
        show={show_delete_project_type}
        onHide={handle_delete_Close_project_type}
        backdrop="static"
        keyboard={false}
      >
        <Modal.Header closeButton>
        ...
        <Modal.Body>
          please note your are about remove <b>{toolFormValue.name} </b> from
          the system. this action can not be undone
        </Modal.Body>
        <Modal.Footer>
          <Button
            variant="secondary"
            onClick={handle_delete_Close_project_type}
          >
            No
          </Button>
          <Button variant="primary" onClick={handleSubmitDeleteProjectType}>
            Yes
          </Button>
        </Modal.Footer>
      </Modal>
      ...
      <Modal
        show={show_delete_project_category_type}
        onHide={handle_delete_Close_project_category_type}
        backdrop="static"
        keyboard={false}
      >
        <Modal.Header closeButton>
        ...
        <Modal.Footer>
          <Button
            variant="secondary"
            onClick={handle_delete_Close_project_category_type}
          >
            No
          </Button>
          <Button
            variant="primary"
            onClick={handleSubmitDeleteProjectCategoryType}
          >
            Yes
          </Button>
        </Modal.Footer>
      ...
      <Modal
        show={show_delete_priority}
        onHide={handle_delete_Close_priority}
        backdrop="static"
        keyboard={false}
      >
        <Modal.Header closeButton>
        ...
        <Modal.Footer>
          ...
          <Button variant="primary" onClick={handleSubmitDeletePriorityType}>
            Yes
          </Button>
        </Modal.Footer>
      </Modal>
      {/*  Project  Status */}
      <Modal
        show={show_delete_status}
        onHide={handle_delete_Close_status}
        backdrop="static"
        keyboard={false}
      >
        <Modal.Header closeButton>
        ...
        <Modal.Footer>
          ...
          <Button variant="primary" onClick={handleSubmitDeleteProjectStatus}>
            Yes
          </Button>
        </Modal.Footer>
      </Modal>

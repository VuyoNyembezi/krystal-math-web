...
const handleCloseTaskStatus = () => {setShowTaskStatus(false)
  setToolFormValue({
    id:0,
     name:"",
   });
...
const [show_update_task_status, set_update_Show_task_status] = useState(false);
const handle_update_Show_task_status = () => set_update_Show_task_status(true);
const handle_update_Close_task_status= () => {set_update_Show_task_status(false);
  setToolFormValue({
    id:0,
     name:"",
   })
...
const [show_delete_task_status, set_delete_Show_task_status] = useState(false);
const handle_delete_Show_task_status = () => set_delete_Show_task_status(true);
const handle_delete_Close_task_status= () => set_delete_Show_task_status(false);

// environment  modal controller
const [showEnvironment,setShowEnvironment] = useState(false)
const handleCloseEnvironment = () =>{ setShowEnvironment(false);
  setToolFormValue({
    id:0,
     name:"",
   })
...
const [show_update_environment, set_update_Show_environment] = useState(false);
const handle_update_Show_environment = () => set_update_Show_environment(true);
const handle_update_Close_environment= () =>{ set_update_Show_environment(false);
  setToolFormValue({
    id:0,
     name:"",
   })
...
const [show_delete_environment, set_delete_Show_environment] = useState(false);
const handle_delete_Show_environment = () => set_delete_Show_environment(true);
const handle_delete_Close_environment= () => {set_delete_Show_environment(false);
  setToolFormValue({
    id:0,
     name:"",
   })
...
const handleCloseMemberStatus = () => {setShowMemberStatus(false);
  setToolFormValue({
    id:0,
     name:"",
   })
...
const [show_update_member_status, set_update_Show_update_member_status] = useState(false);
const handle_update_Show_member_status = () => set_update_Show_update_member_status(true);
const handle_update_Close_member_status= () =>{ set_update_Show_update_member_status(false);
  setToolFormValue({
    id:0,
     name:"",
   })
...
const [show_delete_member_status, set_delete_Show_member_status] = useState(false);
const handle_delete_Show_member_status = () => set_delete_Show_member_status(true);
const handle_delete_Close_member_status= () => set_delete_Show_member_status(false);
         ...
         operation tools
            ...
            <Card.Body>
                    <Tabs defaultActiveKey="task Status"  className="mb-3">
                      ...
                      <Button variant="outline-info" size='sm' onClick={handleShowTaskStatus}>
                                        Add Task Status
                                    </Button>
                      ...
                      <Button variant="outline-success" size='sm' onClick={handleShowEnvironment}>
                                        Add new Environment
                                    </Button>
                      ...
                      <Button  variant="outline-success" size='sm' onClick={handleShowMemberStatus}>
                                        Add new Status
                                    </Button>
        ...
        <Modal show={showTaskStatus} onHide={handleCloseTaskStatus}>
                    ...
                    <Modal.Body>
                        <Form onSubmit={handleTaskStatusSubmit}>
                                ...
                                <Button size='sm' variant="secondary" onClick={handleCloseTaskStatus}>
                                    Close
                                </Button>{' '}{' '}
...
<Modal show={show_update_task_status} onHide={handle_update_Close_task_status}>
                    <Modal.Header closeButton>
                    ...
                    <Modal.Body>
                        <Form onSubmit={handle_Update_Task_Status_Submit}>
                               ...
                               <br/> 
                                <Button size='sm' variant="secondary" onClick={handle_update_Close_task_status}>
                                    Close
                                </Button>{ '  '}
                                <Button size='sm' variant="primary" type="submit">
                                   Update record
  ...
  {/* Modal for  environment control */}
        ...
        <Modal.Body>
            <Form onSubmit={handleEnvironmentSubmit}>
                    ...
                    <Button size='sm' variant="secondary" onClick={handleCloseEnvironment}>
                        Close
                    </Button>{' '}
                    <Button size='sm' variant="primary" type="submit">
                        Save
...
<Modal show={show_update_environment} onHide={handle_update_Close_environment}>
                    <Modal.Header closeButton>
                    ...
                    <Modal.Body>
                        <Form onSubmit={handle_Update_Environment_Submit}>
                             ...
                             <br/>
                                <Button size='sm' variant="secondary" onClick={handle_update_Close_environment}>
                                    Close
                                </Button>{' '}
                                <Button size='sm' variant="primary" type="submit">
                                   Update record
        ...
        <Modal.Body>
            <Form onSubmit={handleMemberStatusSubmit}>
                    ...
                    <Button size='sm' variant="secondary" onClick={handleCloseMemberStatus}>
                        Close
                    </Button>{' '}
                    <Button size='sm' variant="primary" type="submit">
                        Save
...
<Modal show={show_update_member_status} onHide={handle_update_Close_member_status}>
                    <Modal.Header closeButton>
                    ...
                    <Modal.Body>
                        <Form onSubmit={handle_Update_Member_Status_Submit}>
                               ...
                               <br/>
                                <Button size='sm' variant="secondary" onClick={handle_update_Close_member_status}>
                                    Close
                                </Button>
                                <Button size='sm' variant="primary" type="submit">
                                   Update record
       ...
       {/* DELETE MODAL */}
         {/*  Task  Status */}
         <Modal  show={show_delete_task_status}  onHide={handle_delete_Close_task_status} backdrop="static"  keyboard={false}  >
                  <Modal.Header closeButton>
                  ...
                  <Modal.Footer>
                    <Button size='sm' variant="secondary" onClick={handle_delete_Close_task_status}>
                      No
                    </Button>
                    <Button size='sm' variant="primary" onClick={handleSubmitDeleteTaskStatus}>Yes</Button>
                  </Modal.Footer>
                </Modal>
                         {/*  Enviroment   */}
         <Modal  show={show_delete_environment}  onHide={handle_delete_Close_environment} backdrop="static"  keyboard={false}  >
                  <Modal.Header closeButton>
                  ...
                  <Modal.Footer>
                    <Button size='sm' variant="secondary" onClick={handle_delete_Close_environment}>
                      No
                    </Button>
                    <Button size='sm' variant="primary" onClick={handleSubmitDeleteEnviroment}>Yes</Button>
                  </Modal.Footer>
                </Modal>

                                      {/*  Member Status   */}
         <Modal  show={show_delete_member_status}  onHide={handle_delete_Close_member_status} backdrop="static"  keyboard={false}  >
                  <Modal.Header closeButton>
                  ...
                  <Modal.Footer>
                    <Button size='sm' variant="secondary" onClick={handle_delete_Close_member_status}>
                      No
                    </Button>
                    <Button size='sm' variant="primary" onClick={handleSubmitDeleteMemberStatus}>Yes</Button>
                  </Modal.Footer>
                </Modal>

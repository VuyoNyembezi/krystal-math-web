...
function OperationalProjects() {
  ...
  const handleUpdateProjectClose = () => setShowUpdateProject(false);
  ...
  return (
    <>
      ...
      {/* Update modal  Projects */}
      <Modal
        show={showUpdateProject}
        onHide={handleUpdateProjectClose}
        animation={false}
      >
          ...
          <Form onSubmit={handle_Update_Project_Submit}>
            ...
            <FormGroup>
              ...
              <Input
                ...
                type="text"
                onChange={handleChange}
                value={projectFormValue.business_request_document_link}
              />
            </FormGroup>
            <FormGroup>
              <Label> Team : </Label>

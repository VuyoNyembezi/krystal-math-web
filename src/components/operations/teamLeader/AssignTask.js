...
const handleCloseServerError = () => set_server_error(false);
  ...
  const handleClose_Add_task = () => {setShow_Add_task(false);
    setTaskFormValue({
        name:"",
...
const kickoffDate = `${taskFormValue.kickoff_date +' '+ taskFormValue.kickoff_time}`
    ...
    return(
        <>
          ...
          <FormGroup>
              <Label > Name : </Label>
              <Input  name="name" placeholder="with a Project Or Task Name" type="text" onChange={handleChange} value={taskFormValue.name} required />
          </FormGroup>
    
          <Form.Group className="mb-3">
              <Form.Label>Task Status</Form.Label>
              <Form.Select     name="task_status_id" id="task_status_id" onChange={handleChange}  required>
              ...
              <Form.Select     name="environment_id" id="environment_id" onChange={handleChange}  required>
          ...
          <Form.Group className="mb-3">
              ...
              <Form.Select     name="team_id" id="team_id"onChange={handleChange} value={taskFormValue.team_id} disabled required>
          ...
          <Form.Group className="mb-3">
              ...
              <Form.Select     name="user_id" id="user_id" onChange={handleChange}readOnly required>
        ...
        <FormControl
          aria-label="Name"
          aria-describedby="project-name"
          name="due_date" onChange={handleChange} 
          value={taskFormValue.dueDate } 
          placeholder="date placeholder" 
          type="date" />
        <FormControl name="due_time" 
        onChange={handleChange} 
        value={taskFormValue.dueDate} 
        placeholder="time placeholder" 
        type="time" />
      ...
      <InputGroup>
          ...
          <FormControl as="textarea" aria-label="With textarea"  name="task_comment" maxLength={200} onChange={handleChange}/>
        </InputGroup>
      <br/>

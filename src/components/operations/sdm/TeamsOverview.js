...
function TeamsOverview() {
  ...
  useEffect(() => {
    ...
    if (search_key.project_search === null) {
      ...
      fetch(
        `${URL}/api/auth/team/projects/category_type/all?team_id=${team.id}&category_type=${projectCategory.project_category_type_id}`,
        requestOptions
      )
        .then((response) => response.json())
      ...
      fetch(
        `${URL}/api/auth/projects/team/category/search?team_id=${team.id}&category_type=${projectCategory.project_category_type_id}&search=${search_key.project_search}`,
        requestOptions
      )
        .then((response) => response.json())
        .then((res) => setProjectData(res.data));
      ...
      <Container fluid>
        ...
        <Col sm={4}>
          <Card className="shadow">
            ...
            <Card.Body className="sdm-teams-card-details-card">
        ...
        <Col sm={4}>
              <Card className="shadow">
                <Card.Header>
                  <b>{team.name}</b> over view
                </Card.Header>
                <Card.Body className="sdm-team-overview-card-details-card">
                  <Tabs
            ...
            <Col sm={4}>
              <Card className="shadow">
                ...
                <Card.Body className="sdm-teams-projects-card-details-card">
                  <Table size="sm" striped bordered hover>
                    <thead>
                      <tr>
                        <th> Name </th>

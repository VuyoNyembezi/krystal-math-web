...
function DashBoardSDM() {
  ...
  const [Team_live_issues_CounterData, set_Team_Live_Issues_Counter_Data] =
    useState([]);
  ...
  useEffect(() => {
    ...
    if (
      ...
      fetch(
        `${URL}/api/auth/team/projects/all?team_id=${team.id}`,
        requestOptions
      )
        .then((response) => response.json())
  ...
  function handle_Search_Project_Submit(event) {
    ...
    fetch(
      `${URL}/api/auth/projects/team/all/search?team_id=${team.id}&search=${search_key.project_search}`,
      requestOptions
    )
      .then((response) => response.json())
      .then((res) => setProjectData(res.data));
      ...
      body: JSON.stringify({
        project: {
          ...
          business_request_document_status:
            projectFormValue.business_request_document_status,
          project_status_id: projectFormValue.project_status_id,
          business_request_document_link:
            projectFormValue.business_request_document_link,
      ...
      <main className="mt-3">
        <Container fluid>
          <Card className="shadow border-0 mb-7">
            ...
            <Card.Body className="sdm-dashboard">
              <Tabs defaultActiveKey="home" transition={true} className="mb-3">
                    ...
                    <Row>
                      <Col sm={8}>
                        <Card className="shadow">
                          <Card.Body className="sdm-dashboard-projects-tab-project-teams-card">
                            ...
                            <Card>
                              ...
                              <Card.Body className="sdm-dashboard-projects-tab-project-teams-card-projects-card">
                      ...
                      <Col>
                        <Card className="shadow">
                          <Card.Header>
                            <b>{projectValue.name}</b> Project Details
                          </Card.Header>
                          <Card.Body className="sdm-dashboard-projects-tab-project-details-card">
                            <Row>
                              <Col>Name :</Col>
                              <Col>
                            ...
                            <Row>
                              ...
                              <Col>
                                <Badge
                                  style={{ height: "25px" }}
                                  bg={projectValue.priority_level}
                                  size="sm"
                                >
                            ...
                            <Row>
                              ...
                              <Col>
                                <ProgressBar
                                  ...
                                  striped
                                  variant={projectValue.status_level}
                ...
                <Tab eventKey="overview" title="Teams & Projects Overview">
                  <Container fluid>
                    <Card>
                      <Card.Body className="sdm-dashboard-overview-tab ">
                        <Row>
                          <Col>
                            <Card className="shadow" fluid>
                              <Card.Header>Projects Overview</Card.Header>

                              <Card.Body className="sdm-dashboard-overview-tab-project-chart-card">
                                <Tabs
                          ...
                          <Col>
                            <Card className="shadow">
                              <Card.Header>
                                Projects On Teams Overview
                              </Card.Header>
                              <Card.Body className="sdm-dashboard-overview-tab-project-team-overview-card">
                                <Row>
                                  <Table size="sm" striped bordered hover>
                                    <thead>
                                      <tr>
                                ...
                                <Row>
                                  <Col>
                                    <Card.Header>
                                      <b>{team.name}</b> Projects Counters
                                    </Card.Header>
                                    <Card.Body>
                                      <Row>
                                        <Col>Pending</Col>
                                  ...
                                  <Col>
                                    <Card.Header>
                                      <b>{team.name}</b> Live Issues Counters
                                    </Card.Header>
                                          ...
                                          <Badge pill bg="danger">
                                            <CountUp
                                              start={0}
                                                ...
                                                Team_live_issues_CounterData.pending
                                              }
                                              delay={0}
                                            >
                                              {({ countUpRef }) => (
                                          ...
                                          <Badge pill bg="success">
                                            <CountUp
                                              start={0}
                                                ...
                                                Team_live_issues_CounterData.completed
                                              }
                                              delay={0}
                                            >
                                              {({ countUpRef }) => (
          ...
          <Modal.Body>
            <Row>
              ...
              <Col>
                {" "}
                <Nav className="justify-content-end">
                  <div className="col-md-6 col-sm-8 me-2">
                    <Form
                      onSubmit={handle_Search_Project_Submit}
                      className="d-flex"
                    >
